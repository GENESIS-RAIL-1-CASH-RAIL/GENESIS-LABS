...
const SEED_ENTRIES: Omit<BacklogEntry, "lastCheckedAt">[] = [
  ...
  },
  {
    ...
    blocker: "Needs execution telemetry pipeline from CEX/Beachhead executors back to Ingestion Gate. New feedback loop architecture.",
  ...
  },
  {
    ...
    blocker: "Requires recursive intel pattern in CIA + execution log ingestion. New concept: CIA as self-observer, not just external observer.",
...
export class BacklogService {
  ...
  private entryCounter = 16; // Start after WD-016
